...
if [ -f ./powersOfTau28_hez_final_18.ptau ]; then
    ...
    curl https://hermez.s3-eu-west-1.amazonaws.com/powersOfTau28_hez_final_18.ptau --output powersOfTau28_hez_final_18.ptau
fi
...
if [ -f ./build/sudoku/verification_key.json ]; then
    ...
    snarkjs plonk setup build/sudoku.r1cs powersOfTau28_hez_final_18.ptau build/sudoku/circuit_final.zkey 
